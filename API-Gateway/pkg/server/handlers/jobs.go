...
import (
	...
	"github.com/14jasimmtp/GigForge-Freelancer-Marketplace/utils/convert"
...
func (h *JobsHandler) SendProposal(c *fiber.Ctx) error{
	...
	_,err=convert.ConvertAllMultipartFilesToBytes(req.Attachments)
	if err != nil {
		return c.Status(400).JSON(
			res.CommonRes{
				Status:  "failed",
...
func (h *JobsHandler) EditJob(c *fiber.Ctx) {
